/* [project]/node_modules/react-select-search/style.css [app-client] (css) */
...
.select-search-input::-webkit-search-decoration, .select-search-input::-webkit-search-cancel-button, .select-search-input::-webkit-search-results-button, .select-search-input::-webkit-search-results-decoration {
  -webkit-appearance: none;
}
...
.select-search-container:not(.select-search-is-disabled).select-search-has-focus .select-search-input, .select-search-container:not(.select-search-is-disabled) .select-search-input:hover {
...
/*# sourceMappingURL=node_modules_react-select-search_style_b52d8e.css.map*/